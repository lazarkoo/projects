...
namespace MemorijaIgrica
{
    public partial class GameWindow : Form
    {
        //Variables
       // int score = 0; //rezultat
        Random Location = new Random(); // bira nasumicnu vrednost od x i y liste i dodeljuje lokaciju svakoj kartici
        List<Point> points = new List<Point>(); // lista koja ce drzati tacke slicica
        bool again = false; // kada se igra zavrsi pita da li opet zeli da se igra
        PictureBox PendingImage1; // cuva vrednost prve izabrane karte
        PictureBox PendingImage2; // isto samo za drugu
